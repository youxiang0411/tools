...
dynamicLoading.js(servicePath + '/js/angular-expressions.js', () => {});
dynamicLoading.js(servicePath + '/js/downloadify.min.js', () => {});
dynamicLoading.js(servicePath + '/js/swfobject.js', () => {});
